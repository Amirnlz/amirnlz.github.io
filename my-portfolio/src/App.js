  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive health monitoring app with real-time tracking and analytics",
    ...
    },
    {
      title: "EcoCommute",
      description:
        "Sustainable transportation planning app with carbon footprint tracking",
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b">
            <div className="px-4 py-2 space-y-2">
              ...
              <a href="#projects" className="block py-2 hover:text-blue-600">
                Projects
              </a>
              <a href="#skills" className="block py-2 hover:text-blue-600">
                Skills
              </a>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-lg mb-8">
                Senior Mobile Developer specializing in creating intuitive and
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="#projects"
                  className="border border-gray-300 px-6 py-3 rounded-lg hover:border-blue-600"
                >
                  View my work
                </a>
              </div>
